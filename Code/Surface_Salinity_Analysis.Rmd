---
title: "Surface Salinity Indicators of Habitat and Ecosystem Change"
author: "Matt Dzaugis"
date: "`r Sys.Date()`"
output: 
  html_document:
...
Npsi <- 2 # estimated number of breakpoints
...
```{r breakpoint_tests}
pscore_fun(indicator_sel, season_sel, stat_areas_sel, 1)
...
```{r slope_segments}
bp <- slope_bp_fun(indicator_sel, season_sel, stat_areas_sel, 1)
summary(bp)
plot(bp)
df <- allIndicators %>% 
