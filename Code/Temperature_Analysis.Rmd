---
title: "Temperature Indicators of Habitat and Ecosystem Change"
author: "Matt Dzaugis"
date: "`r Sys.Date()`"
output: 
  html_document:
...
pscore_fun <- function(indicator, season, stat_areas, nbreak){
  df <- allIndicators %>% 
    filter(Indicator == indicator,
           Season == season,
           stat_area == stat_areas)
...
```{r breakpoint_tests}
pscore_fun("oisst", "all", "511-513", 1)
...
```{r fvcom_sstbreakpoint_tests}
pscore_fun("fvcom_sst", "all", "511-513", 1)
davies_fun("fvcom_sst", "all", "511-513")
```

#### Slope breakpoint

```{r ffvcom_sstslope_segments}
...
### FVCOM BT Temperature {.tabset}

#### Time series plots

```{r fvcom_Temperature_plots}
...
```{r fvcom_breakpoint_tests}
pscore_fun("fvcom_bt", "all", "511-513", 1)
davies_fun("fvcom_bt", "all", "511-513")
```

#### Slope breakpoint

```{r fvcom_slope_segments}
